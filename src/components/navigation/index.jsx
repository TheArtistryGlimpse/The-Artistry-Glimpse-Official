                        ...
                        : (
                            <>
                                <motion.div
                                    ...
                                    variants={container}
                                    initial="hidden"
                                    animate="show" className='w-full px-2.5 space-y-4 xs:p-0 xs:w-max flex flex-col items-start xs:items-center justify-center relative group'>
                                    {
                                ...
                                <motion.div
                                    ...
                                    variants={container}
                                    initial="hidden"
                                    animate="show" className='w-full px-2.5 space-y-4 xs:p-0 xs:w-max flex flex-col items-end xs:items-center justify-center relative group'>
                                    {
